        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StayDates = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerNightCharges = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditCardDetails = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Staff controlling management activities of hotel", "Management" },
                    { 2, "Staff controlling reception", "Reception" }
                });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "RoleId", "Description", "UserRole" },
                values: new object[,]
                {
                    { 1, "Hotel owner", "Owner" },
                    { 2, "Hotel manager", "Manager" },
                    { 3, "Front desk staff", "Receptionist" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "DepartmentId", "Email", "Password", "RoleId", "Username" },
                values: new object[] { 1, 1, "admin@example.com", "owner123", 1, "owner" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "DepartmentId", "Email", "Password", "RoleId", "Username" },
                values: new object[] { 2, 1, "manager@example.com", "manager123", 2, "manager" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "DepartmentId", "Email", "Password", "RoleId", "Username" },
                values: new object[] { 3, 2, "reception@example.com", "reception123", 3, "reception" });
